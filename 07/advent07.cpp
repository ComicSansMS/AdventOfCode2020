...
int main(int argc, char* argv[])
{
    ...
    auto const g = parseInput(*input);

    fmt::print("First result is {}\n", countContainersFor(g, Color{ Color::Attribute::shiny, Color::Hue::gold }));
    fmt::print("Second result is {}\n", countBagsContainedIn(g, Color{ Color::Attribute::shiny, Color::Hue::gold }));
